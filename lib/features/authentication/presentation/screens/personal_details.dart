...
import 'package:alhikmah_schedule_student/features/authentication/presentation/screens/course_selection.dart';
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField(
                value: authProvider.selectedLevel,
                ...
                onChanged: (level){authProvider.updateSelectedLevel(level!);},
              ...
              DropdownButtonFormField(
                value: authProvider.programmes.isNotEmpty?authProvider.programmes.first:authProvider.programme,
              ...
              ScheduleButton(
                ...
                onPressed: () {
                  authProvider.uploadPersonalInformation(matric: matricController.text);
                  // Navigator.push(
                  //   context,
                  //   MaterialPageRoute(
